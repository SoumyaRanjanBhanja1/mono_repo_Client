const About = () => (
  <section id="about" className="bg-gray-100 text-gray-800 py-20 px-6">
    <div className="max-w-5xl mx-auto text-center">
      ...
      <p className="text-lg leading-relaxed">
        ...
        and leadership in high-pressure environments. I’ve led cross-functional teams and
        delivered excellence across power, steel, and engineering industries.
      </p>
    </div>
  </section>
);
